...
Сценарий: Локальные переменные
	...
	И в таблице "List" я перехожу к строке:
		...
		| 'CI'    | 'USD'    | '24.02.2021 10:04:33' | 'Поставщик 1' | '1'     | 'Собственная компания 1' | 'Поставщик 1 (1 соглашение)' | 'Склад 1 (с контролем остатка)' | 'Поступление товаров и услуг 1 от 24.02.2021 10:04:33' | 'Завершен' | '8 500,05' |
	...
	И в табличном документе 'ResultTable' я перехожу к ячейке "R10C3"
	...
	Тогда табличный документ "ResultTable" равен:
		...
		| ''                                                     | '24.02.2021 10:04:33' | '20'         | '3 000,05' | '2 500'             | ''             | 'Собственная компания 1' | 'Подразделение 1'           | 'en наименование не заполнено' | 'USD'    | 'Поступление товаров и услуг 1 от 24.02.2021 10:04:33' | 'Товар без характеристик' | '16651dd1-4d7d-4d22-bdf4-ee2a2b196cba' | 'Нет'               |
		...
		| ''                                                     | '24.02.2021 10:04:33' | '50'         | '5 500'    | '4 583,33'          | ''             | 'Собственная компания 1' | 'Подразделение 1'           | 'en наименование не заполнено' | 'USD'    | 'Поступление товаров и услуг 1 от 24.02.2021 10:04:33' | 'S/Красный'               | '2ce7a713-e5f5-4b4c-b5b7-0bd4a98dff06' | 'Нет'               |
...
Сценарий: Глобальные переменные
	...
	// Для перезаписи можно использовать $$$$
	//И я сохраняю навигационную ссылку текущего окна в переменную "$$$$СсылкаТоварБезХарактеристик$$$$"
